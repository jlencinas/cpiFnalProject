...
<script type="text/javascript"
	src="<c:url value="/resources/js/product-page.js"/>"></script>
...
<div class="container-product">
	<div class="container-card-container">
		<div class="container-card-container-title">
			<h1>Available Products</h1>
		</div>
		<div class="container-card-container-products">
						...
						<div class="card-container">
							<div class="card-left-container">
								<div class="card-image">
									<img src="${product.productPicture}" alt="products">
								</div>
							</div>
									...
									<div class="card-desc">
										...
										<div class="quantity-input">
											<button type="button" class="button-decrease-quantity"
												onclick="decreaseQuan(${product.productID})"
												id="button-decrease-quantity">-</button>
											<input name=quantity class="product-quantity"
												id="product-quantity-${product.productID}"
												onkeyup="checkEmpty(${product.productID})" type="text"
												value="1">
											<button type="button" class="button-increase-quantity"
												onclick="increaseQuan(${product.productID})"
												id="button-increase-quantity">+</button>
										</div>
									</div>

									<div class="button-selection">
										<input id="cart-value" type="hidden"
											value="${product.productID}">
										<button type="submit" class="button-addToCart" name="itemnum"
											id="button-addToCart"
